...
import { saveRemote, GOOGLE_URL } from "../utils/sync";

export default function Caisse({produits, cbcData, onAdd, ventes, onDelete: deleteVente, onRembourser, journalCaisse, addJournalEvent}){
